...
A specialized .cursorrules prompt for creating comprehensive defect reproduction and tracking tests
using Playwright with TypeScript and case ID tagging.
...
This prompt helps QA teams create comprehensive defect tracking and reproduction tests using
Playwright with case ID tagging. It focuses on organizing tests logically, maintaining traceability
to manual test cases, and generating structured reports for defect tracking.

## Overview of .cursorrules Prompt

The .cursorrules prompt guides QA engineers in creating effective defect tracking tests using
